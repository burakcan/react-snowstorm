...
var _snowStormJs2 = _interopRequireDefault(_snowStormJs);

var SnowStorm = (function (_Component) {
  _inherits(SnowStorm, _Component);

  function SnowStorm(props, context) {
    _classCallCheck(this, SnowStorm);

    _get(Object.getPrototypeOf(SnowStorm.prototype), 'constructor', this).call(this, props, context);
    this.storm = new _snowStormJs2['default'](props);
  }
